...
const Register = () => {
    ...
    return (
        <div className="register flex items-center justify-center min-h-screen bg-gray-50 px-4">
            <div className="register-form w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
